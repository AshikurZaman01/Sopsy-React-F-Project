...
const Hero = ({ handleOrderPopup }) => {
    ...
    return (
        <div className="container relative overflow-hidden min-h-[550px] sm:min-h-[650px] bg-gray-100 flex justify-center items-center dark:bg-gray-950 dark:text-white duration-200">
